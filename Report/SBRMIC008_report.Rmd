---
title: "Applying Multivariate Techniques to MRI Scans of Individuals With and Without Alzheimers"
...
```{r LLE, echo = FALSE, fig.height=4, fig.width=4, results='asis', include = FALSE}
...
```{r lleTop, echo = FALSE, fig.height=4, fig.width=4, results='asis', include = FALSE}
# LLE Top Scans
...
```{r lleSide, echo = FALSE, fig.height=4, fig.width=4, results='asis', include = FALSE}
# LLE Side Scans
...
```{r autoencoder, echo = FALSE, fig.height=4, fig.width=4, results='asis', include = FALSE}
...
```{r topAutoEncoder, echo = FALSE, fig.height=4, fig.width=4, results='asis', include = FALSE}
...
```{r sideAutoEncoder, echo = FALSE, fig.height=4, fig.width=4, results='asis', include = FALSE }
...
```{r convolutionFront, echo = FALSE, fig.height=4, fig.width=4, results='asis', include = FALSE}
...
dev.off()
dbscanFrontConv = extractDBSCAN(optFrontConv, eps_cl = 4)
...
```{r convTopScan, echo = FALSE, fig.height=4, fig.width=4, results='asis', include = FALSE}
...
dev.off()
dbscanTopConv = extractDBSCAN(optTopConv, eps_cl = 3.2)
...
```{r convSideScan, echo = FALSE, fig.height=4, fig.width=4, results='asis', include = FALSE}
...
dev.off()
dbscanSideConv = extractDBSCAN(optSideConv, eps_cl = 3.2)
...
Sigmoid with linear and relu were the 2 models that provided the lowest MSE and thus those were chosen. Sigmoid with linear gave the lowest of the 2 and thus was used for all 3 different scans, based on the tables from the appendix. The bottleneck being 128 was chosen for computational efficiency as well as it being commonly used size for images when being reduced. The epsilon for DBScan was 0.0005 for front scans, 0.0004 for top scans and 0.0006 for side scans based on the reachability plots in the appendix. 
...
\newpage
# Appendix 
```{r autoEncoderNetwork, echo = FALSE, fig.show = "hold", fig.align = "center", out.height = "50%", out.width="60%", fig.cap = "AutoEncoder Network Design"}
knitr::include_graphics(c("AutoEncoderNetwork.png"))
```

```{r LLEReachability, echo = FALSE, fig.show = "hold", fig.align = "center",fig.cap = "Epsilon = 10 is chosen as the cutoff"}
knitr::include_graphics(c("LLEReachability.png"))

``` 

```{r LLETopReachability, echo = FALSE, fig.show = "hold", fig.align = "center",fig.cap = "Epsilon = 10 is chosen as the cutoff"}
...
```
```{r AeFrontReachability, echo = FALSE, fig.show = "hold", fig.align = "center",fig.cap = "Epsilon = 0.0012 is chosen as the cutoff"}
knitr::include_graphics(c("AeFrontReachability.png"))
```
```{r AeTopReachability, echo = FALSE, fig.show = "hold", fig.align = "center", fig.cap = "Epsilon = 0.0008 is chosen as the cutoff"}
knitr::include_graphics(c("AeTopReachability.png"))
```
```{r AeSideReachability, echo = FALSE, fig.show = "hold", fig.align = "center",fig.cap = "Epsilon = 0.0004 is chosen as the cutoff"}
knitr::include_graphics(c("AeSideReachability.png"))
```
```{r ConvFrontReachability, echo = FALSE, fig.show = "hold", fig.align = "center",fig.cap = "Epsilon = 4 is chosen as the cutoff"}
knitr::include_graphics(c("ConvFrontReachability.png"))
```
```{r ConvTopReachability, echo = FALSE, fig.show = "hold", fig.align = "center",fig.cap = "Epsilon = 3.2 is chosen as the cutoff"}
knitr::include_graphics(c("ConvTopReachability.png"))
```
```{r ConvSideReachability, echo = FALSE, fig.show = "hold", fig.align = "center",fig.cap = "Epsilon = 3.2 is chosen as the cutoff"}
knitr::include_graphics(c("ConvSideReachability.png"))
```

```{r MSETables, echo = FALSE}

kable(mseSideAEDF, caption = "MSE For Auto Encoder for Front Scans")

kable(mseSideAEDF, caption = "MSE For Auto Encoder for Top Scans")
