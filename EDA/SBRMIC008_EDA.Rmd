...
![MRI Image]("F:/.University/5th Year/STA5069Z/SBRMIC008_STA5069Z_Project/Images/OAS1_0058_MR1_mpr_n4_anon_111_t88_gfc_cor_110.jpg")
*figure 1: Front MRI Scan*

![MRI Image]("F:/.University/5th Year/STA5069Z/SBRMIC008_STA5069Z_Project/Images/OAS1_0058_MR1_mpr_n4_anon_111_t88_gfc_sag_95.jpg")
*figure 1: Side MRI Scan*

![MRI Image]("F:/.University/5th Year/STA5069Z/SBRMIC008_STA5069Z_Project/Images/OAS1_0058_MR1_mpr_n4_anon_111_t88_gfc_tra_90.jpg")
*figure 1: Top MRI Scan*

Each individual has these same 3 MRI scans. 

```{r eda, echo = FALSE}

data = readRDS("F:/.University/5th Year/STA5069Z/SBRMIC008_STA5069Z_Project/pixelsMatrix")
...
cdr0 = length(noNA[noNA == 0])
cdr05 = length(noNA[noNA == 0.5])
cdr1 = length(noNA[noNA == 1])
cdr2 = length(noNA[noNA == 2])
cdr3 = length(noNA[noNA == 3])



cdrDataFrame = data.frame("CDR = NA" = missingCDR, "CDR = 0" = cdr0, "CDR = 0.5" = cdr05, "CDR = 1" = cdr1, "CDR = 2" = cdr2, "CDR = 3" = cdr3)
